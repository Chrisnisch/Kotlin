...
fun seconds(hours: Int, minutes: Int, seconds: Int):
        Int = seconds + minutes * 60 + hours * 60 * 60
...
fun lengthInMeters(sagenes: Int, arshins: Int, vershoks: Int):
        Double = (sagenes * 48 * 4.445 + arshins * 16 * 4.445 + vershoks * 4.445) / 100
...
fun angleInRadian(deg: Int, min: Int, sec: Int):
        Double = deg * PI / 180 + min * PI / (60 * 180) + sec * PI / (60 * 60 * 180)
...
fun accountInThreeYears(initial: Int, percent: Int):
        Double = initial.toDouble() * (1 + percent.toDouble() / 100).pow(3)
